...
const SignFile_1 = require("./application/use-cases/SignFile");
const VerifyFileSignature_1 = require("./application/use-cases/VerifyFileSignature");
const GetPublicKeyByUser_1 = require("./application/use-cases/GetPublicKeyByUser");
// Repositories
...
const signFile = new SignFile_1.SignFile(fileRepository);
const verifySignature = new VerifyFileSignature_1.VerifyFileSignature(fileRepository, keyRepository);
const getPublicKeyByUserId = new GetPublicKeyByUser_1.GetPublicKeyByUser(keyRepository);
// controllers
const keyController = new KeyController_1.KeyController(generateKeyPair, getPublicKeyByAlias, getPublicKeyByUserId);
...
const fileController = new FileController_1.FileController(uploadFile, getFileById, signFile, verifySignature);
