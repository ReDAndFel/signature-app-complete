...
const privateKey = fs_1.default.readFileSync(process.env.SSL_KEY_PATH || "server.key", "utf8");
const certificate = fs_1.default.readFileSync(process.env.SSL_CERT_PATH || "server.crt", "utf8");
